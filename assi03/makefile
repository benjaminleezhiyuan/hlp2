...
test : $(EXEC)
	./$(EXEC) worldpop.txt
	diff -y --strip-trailing-cr --suppress-common-lines your-name-asc.txt name-asc.txt
	diff -y --strip-trailing-cr --suppress-common-lines your-name-des.txt name-des.txt
	diff -y --strip-trailing-cr --suppress-common-lines your-pop-asc.txt  pop-asc.txt
	diff -y --strip-trailing-cr --suppress-common-lines your-pop-des.txt  pop-des.txt